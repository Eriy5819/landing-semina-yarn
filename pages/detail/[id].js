        ...
        <div className='d-flex flex-wrap justify-content-lg-center gap'>
          ...
          <div className='d-flex flex-column card-event'>
            ...
            <div className='d-flex align-items-center gap-3 mt-3'>
              ...
              />
              <div>
                <div className='speaker-none'>{detailPage?.talent?.name}</div>
            ...
            <h6>Get Ticket</h6>
            {detailPage.tickets.map((tickets) => (
              <>
                {tickets.statusTicketCategories ? (
                  <>
                    {' '}
                    <div className='price my-3'>
                      {tickets.price === 0 ? 'free' : `$${tickets.price}`}
                      <span>/person</span>
                    </div>
                    ...
                    {detailPage.stock !== 0 && (
                      <Button
                        variant={'btn-green'}
                        action={() =>
                          handleSubmit(tickets._id, detailPage.organizer)
                        }
                      >
                        Join Now
                      </Button>
